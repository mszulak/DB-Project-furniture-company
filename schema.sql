-- 1. Tabele słownikowe i niezależne
...
CREATE TABLE Payments (
    ...
    payment_date DATETIME DEFAULT GETDATE() -- Poprawione z TIMESTAMP na DATETIME
);
...
CREATE TABLE Reviews (
    ...
    review VARCHAR(MAX), -- Poprawione na VARCHAR(MAX) dla SQL Server
    FOREIGN KEY (product_id) REFERENCES Products(id),
    FOREIGN KEY (customer_id) REFERENCES Customers(id)
);
